...
class Customer
{
     ...
     * @var string
     *
     * @ORM\Column(name="planClient", type="string", length=255, nullable=true)
     */
    private $planClient;
     ...
     * @var int
     *
     * @ORM\Column(name="ProfilClient", type="integer", nullable=true)
     */
     ...
     * Set planClient
     *
     * @param string $planClient
     *
     * @return Customer
     */
    public function setPlanClient($planClient)
    {
